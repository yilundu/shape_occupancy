...
sys.path.append("/home/jiahui/shape_occupancy/airobot/src/airobot")
...
from eof_robot.config.default_data_gen_cfg import get_data_gen_cfg_defaults
from eof_robot.utils import util, path_util
from eof_robot.robot.multicam import MultiCams
from eof_robot.utils.experiment_utils import DistractorSampler, DistractorObjManager, DistractorObjectEnv
from eof_robot.share.globals import (
    ...
    while True:
        ...
        if msg == "SAMPLE":
            ...
            for i, cam in enumerate(cams.cams): 
                ...
                _, depth, seg = cam.get_images(get_rgb=True, get_depth=True, get_seg=True)
...
def main(args):
    ...
    # get train samples
    objects_raw = os.listdir(osp.join(shapenet_data_dir, obj_class, SHAPENET_ID_DICT[obj_class])) 
